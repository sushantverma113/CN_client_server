...
def main(filename):
    ...
    pd.DataFrame(part1).to_csv("./toSend/part1.csv",index=None,header=None)
    pd.DataFrame(part2).to_csv("./toSend/part2.csv",index=None,header=None)
    pd.DataFrame(part3).to_csv("./toSend/part3.csv",index=None,header=None)
